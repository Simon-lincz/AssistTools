...
public class SpeicalKeyListener {
	...
	public void startWatch() {
		Log.d(TAG, "startWatch " + (mRecevier != null ) + " mIsWatching " + mIsWatching);
	...
	public void stopWatch() {
		Log.d(TAG, "stopWatch " + (mRecevier != null ) + " mIsWatching " + mIsWatching);
		if (mRecevier != null && mIsWatching) {
			mIsWatching = false;
	...
	class InnerRecevier extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals(Intent.ACTION_CLOSE_SYSTEM_DIALOGS)) {
				...
				if (reason != null) {
					Log.e(TAG, "onReceive action:" + action + ",reason: " + reason);
					if (mListener != null) {
