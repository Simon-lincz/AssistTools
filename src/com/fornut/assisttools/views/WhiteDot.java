...
public class WhiteDot extends View {
    ...
    void refreshLayoutParams() {
        ...
        mRingRadius = mResources
                .getDimensionPixelSize(R.dimen.whitedot_ringRadius);
        mRingWidth = mResources
                .getDimensionPixelSize(R.dimen.whitedot_ringWidth);
        mXRadiusCorner = mResources
                .getDimensionPixelSize(R.dimen.whitedot_xRadiusCorner);
        mYRadiusCorner = mResources
                .getDimensionPixelSize(R.dimen.whitedot_yRadiusCorner);
        ...
        mAnimationDuration = mResources
                .getInteger(R.integer.whitedot_animation_duration);
        mBackground_strokeWidth = mResources
                .getDimensionPixelSize(R.dimen.background_FrameStrokeWidth);
        mWhiteDotBackground_Rect = new RectF(mBackground_strokeWidth,
                mBackground_strokeWidth, mWidth - mBackground_strokeWidth,
                mHeight - mBackground_strokeWidth);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(mWhiteDotBackground_Rect, mXRadiusCorner,
                mYRadiusCorner, mPaint);// 第二个参数是x半径，第三个参数是y半径
        ...
        if (mEnableCustomBackground && mCustomBackgroundBitmap != null) {
            ...
            canvas.drawBitmap(mCustomBackgroundBitmap,
                    mCustomBackgroundBitmap_Rect, mWhiteDotBackground_Rect,
                    mPaint);
            return;
        }
        ...
        //
        // mPath.reset();
        // mPath.addCircle(mWidth / 2, mHeight / 2, mRingRadius + mRingWidth,
        // Path.Direction.CCW);
        // canvas.clipPath(mPath, Region.Op.DIFFERENCE);
        // mPath.reset();
        // mPath.addCircle(mWidth / 2, mHeight / 2, mRingRadius,
        // Path.Direction.CCW);
    ...
    void setWhiteDotBackground(Bitmap bitmap) {
        ...
        mCustomBackgroundBitmap_Rect = new Rect(0, 0,
                mCustomBackgroundBitmap.getWidth(),
