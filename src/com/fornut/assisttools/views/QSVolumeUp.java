...
public class QSVolumeUp extends QuickSwitchBase {

	private String TAG = "AssistTools-" + QSVolumeUp.class.getSimpleName();

	public QSVolumeUp(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		setQuickSwitchcustomTitle(R.string.qs_name_volumeup);
	}

	@Override
	public String getQuickSwitchName() {
		// TODO Auto-generated method stub
		return QSVolumeUp.class.getSimpleName();
	}
	...
	public void onClickCallback() {
		// TODO Auto-generated method stub
		KeySimulator.getInstance(mContext).setVolumeUP();
	}
